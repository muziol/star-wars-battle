...
const comparePlayersCards = (p1: PlayerModel, p2: PlayerModel): PlayerModel | null => {
    if (!p1.card || !p2.card) {
        return null;
    }
...
export const addScoreToPlayer = (players: PlayerModel[], scorePlayerId: number): PlayerModel[] => {
...
export const mapCardsToPlayers = (players: PlayerModel[], cards: (CardPerson | CardStarship)[]): PlayerModel[] => {
